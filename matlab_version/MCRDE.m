function [Out_MCRDE Out_pdf] =MCRDE(x,m,c,tau,Scale)
%
...
Out_MCRDE=NaN*ones(1,Scale);
Out_MCRDE(1)=DisEn_NCDF(x,m,c,tau,1);
...
for j=2:Scale
    xs = Multi(x,j);
    Out_MCRDE(j) =DisEn_NCDF_ms(xs,m,c,mu,sigma,tau,1);
end
