function [Out_FuzzyDisEn, npdf]=FuzzyDisEn_NCDF_ms(x,m,nc,mu,sigma,tau,type)
%
% This function calculates Fuzzy dispersion entropy (FuzzyDisEn) 
% of a univariate using normal cumulative distribution function (NCDF) with defined mean (mu) and standard deviation (sigma) values.
%
% Inputs:
%
